...
import org.primefaces.model.TreeNode;
    ...
    public static String EXPANDED_ICON_CLASS_V = "ui-tree-toggler ui-icon ui-icon-minus";
    public static String COLLAPSED_ICON_CLASS_V = "ui-tree-toggler ui-icon ui-icon-plus";
